...
export function InvoicesList({ onSelectInvoice }: InvoicesListProps) {
  ...
  const filteredInvoices = invoices.filter((invoice) =>
    ...
    (invoice.clientName && invoice.clientName.toLowerCase().includes(searchText.toLowerCase()))
  );
      ...
      {isLoadingInvoices ? (
        ...
        <View style={styles.emptyContainer}>
          <Text style={styles.emptyText}>
            {searchText ? 'Nenhuma nota fiscal encontrada' : 'Você ainda não tem notas fiscais'}
          </Text>
